"""
Created on 12:49 AM , 2/12/17, 2017
...
# TODO: what should be the param here? test or train
y_scores = linear_clf.decision_function(X_test)
...
plt.title('ROC-CURVE of hard-margin SVM Classification')
plt.show()
