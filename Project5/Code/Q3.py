...
def calculate_linear_regression(hashtag):
    ...
    plt.clf
    fig, ax = plt.subplots()
    ax.scatter(training_data['num_tweets'], predicted_values)
    #ax.plot([0,max(target_data)], [0,0], 'k--', lw = 4)
    ax.set_xlabel('Number of Tweets', fontsize = 10)
    ax.set_ylabel('Predicted value', fontsize = 10)
    plt.title('Predicted value vs. Number of Tweets', fontsize = 15)
    #plt.axis([0,10000,-1200,400])
    plt.show()

    plt.clf
    fig, ax = plt.subplots()
    ax.scatter(training_data['num_authors'], predicted_values)
    #ax.plot([0,max(target_data)], [0,0], 'k--', lw = 4)
    ax.set_xlabel('Number of Authors', fontsize = 10)
    ax.set_ylabel('Predicted value', fontsize = 10)
    plt.title('Predicted value vs. Number of Authors', fontsize = 15)
    #plt.axis([0,10000,-1200,400])
    plt.show()
    ...
    ax.set_ylabel('Predicted value', fontsize = 10)
    plt.title('Predicted value vs. Ranking Scores', fontsize = 15)
    #plt.axis([0,10000,-1200,400])
    plt.show()
